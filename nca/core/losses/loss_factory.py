...
LOSS_FN_REGISTRY = {
    ...
    "vgg": lambda cfg: VGGStyleOTLoss(device=cfg.DEVICE, overflow_loss=cfg.TRAINING.OVERFLOW_LOSS, overflow_weight=cfg.TRAINING.OVERFLOW_WEIGHT, proj_n=cfg.TRAINING.VGG_PROJ_N),
